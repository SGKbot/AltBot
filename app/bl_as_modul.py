...
HS = "Здравствуйте." \
     "\n" \
     "\n" \
     "Этот бот предназначен для помощи при создании сообщений в вашем канале." \
     "\n" \
     ...
     "\n" \
     "<b>Посмотреть короткое видео по работе бота.</b>" "\n" \
     "<a href='https://youtu.be/4WjQxTpch5c'> " \
     "Создание сообщения.</a>" \
     "\n" \
     "<a href='https://youtu.be/8D8LCZZSO5o'> " \
     "Редакция отложенного сообщения.</a>" \
     "\n \n" \
